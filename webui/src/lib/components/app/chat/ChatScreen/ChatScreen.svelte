	...
	>
		<div class="w-full max-w-[48rem] px-4">
			<div class="mb-10 text-center" in:fade={{ duration: 300 }}>
				<img src="{base}/alpaca.svg" alt="alpacabitollama" class="mx-auto mb-4 h-16 w-16" />
				<h1 class="mb-2 text-2xl font-semibold tracking-tight md:text-3xl">Alpacabitollama</h1>
